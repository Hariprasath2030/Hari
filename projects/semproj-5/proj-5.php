...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['edit'])) {
        ...
        $result = $con->query("SELECT * FROM project5 WHERE id='$selectedStudentId'");
    ...
    if (isset($_POST['save'])) {
        foreach ($_POST['students'] as $studentId => $details) {
            ...
            $updateQuery = "UPDATE project5 SET team_no='$team_no', project_title='$project_title', project_status='$project_status', publication_type='$publication_type', publisher_name='$publisher_name' WHERE id='$studentId'";
    ...
    if (isset($_POST['add'])) {
        ...
        $insertQuery = "INSERT INTO project5 (name, roll_no) VALUES ('$newStudentName', '$newStudentRollNo')";
...
<title>Project details for sem-5</title>
<style>
...
<nav>
  ...
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
    ...
    <div class="container">
        ...
        $result = $con->query("SELECT * FROM project5");
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='/phpupload/upload5.html?id=" . $row['id'] . "'><button type='button'>Upload</button></a></td>";
               echo "<td><a href='delete5.php?id=" . $row['id'] . "' onclick='return confirm(\"Are you sure you want to delete this student?\")'><button type='button'>Delete</button></a></td>";
                echo "</tr>";
            }
