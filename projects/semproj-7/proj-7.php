...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['edit'])) {
        ...
        $result = $con->query("SELECT * FROM project7 WHERE id='$selectedStudentId'");
    ...
    if (isset($_POST['save'])) {
        foreach ($_POST['students'] as $studentId => $details) {
            ...
            $updateQuery = "UPDATE project7 SET team_no='$team_no', project_title='$project_title', project_status='$project_status', publication_type='$publication_type', publisher_name='$publisher_name' WHERE id='$studentId'";
    ...
    if (isset($_POST['add'])) {
        ...
        $insertQuery = "INSERT INTO project7 (name, roll_no) VALUES ('$newStudentName', '$newStudentRollNo')";
...
<title>Project details for sem-7</title>
<style>
...
<nav>
  ...
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
    ...
    <div class="container">
        ...
        $result = $con->query("SELECT * FROM project7");
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='/phpupload/upload7.html?id=" . $row['id'] . "'><button type='button'>Upload</button></a></td>";
               echo "<td><a href='delete7.php?id=" . $row['id'] . "' onclick='return confirm(\"Are you sure you want to delete this student?\")'><button type='button'>Delete</button></a></td>";
                echo "</tr>";
            }
